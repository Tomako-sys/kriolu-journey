  ...
  return (
    <div className="flex flex-col items-center bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-4 gap-4 mt-8 w-full max-w-4xl">
        ...
        <Link to="/community" className="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
          <Users className="h-16 w-16 text-primary" />
          <span className="mt-2 text-lg font-semibold">{t("nav.community")}</span>
        </Link>
      </div>
